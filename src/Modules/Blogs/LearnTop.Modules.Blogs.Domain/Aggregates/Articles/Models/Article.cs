...
using LearnTop.Modules.Blogs.Domain.Aggregates.Articles.ValueObjects;
using LearnTop.Shared.Domain;

namespace LearnTop.Modules.Blogs.Domain.Aggregates.Articles.Models;
...
public class Article : Aggregate
{
    ...
    public static Article CreatePrivate(
        Guid authorId)
    {
        Article article = new()
        {
    ...
    public static Result<Article> CreatePublic(
        Guid authorId, 
        Guid categoryId, 
        string coverName,
        string title, 
